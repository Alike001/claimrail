...
| ----: | ------------------------------ | ---------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------- |
|     1 | Public web, PostgreSQL, worker | Web/database live; worker wallet pending | `/api/health` is `200`; manual worker run is `ready`        | Provide dedicated public Shannon wallet address   |
